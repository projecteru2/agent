...
// GetNodeStatus provides a mock function with given fields: ctx, in, opts
func (_m *CoreRPCClient) GetNodeStatus(ctx context.Context, in *pb.GetNodeStatusOptions, opts ...grpc.CallOption) (*pb.NodeStatusStreamMessage, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *pb.NodeStatusStreamMessage
	if rf, ok := ret.Get(0).(func(context.Context, *pb.GetNodeStatusOptions, ...grpc.CallOption) *pb.NodeStatusStreamMessage); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pb.NodeStatusStreamMessage)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.GetNodeStatusOptions, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
