...
// DeployContainerStats provides a mock function with given fields: container, node
func (_m *Store) DeployContainerStats(container *types.Container, node *coretypes.Node) error {
