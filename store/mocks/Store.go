...
func (_mock *Store) ListRunningWorkloadIDs(ctx context.Context) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ListRunningWorkloadIDs")
	}
...
type Store_ListRunningWorkloadIDs_Call struct {
	*mock.Call
}
...
func (_e *Store_Expecter) ListRunningWorkloadIDs(ctx any) *Store_ListRunningWorkloadIDs_Call {
	return &Store_ListRunningWorkloadIDs_Call{Call: _e.mock.On("ListRunningWorkloadIDs", ctx)}
}
